...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/hypixel` | `npm install @voxgig-sdk/hypixel` |
| Python | `voxgig-sdk-hypixel` | `pip install voxgig-sdk-hypixel` |
| PHP | `voxgig-sdk/hypixel` | `composer require voxgig-sdk/hypixel` |
| Golang | `github.com/voxgig-sdk/hypixel-sdk/go` | `go get github.com/voxgig-sdk/hypixel-sdk/go` |
| Ruby | `voxgig-sdk-hypixel` | `gem install voxgig-sdk-hypixel` |
| Lua | `voxgig-sdk-hypixel` | `luarocks install voxgig-sdk-hypixel` |
