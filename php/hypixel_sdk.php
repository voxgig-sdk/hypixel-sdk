...
class HypixelSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = HypixelHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = HypixelHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!HypixelFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, HypixelFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return HypixelUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = HypixelHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = HypixelHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = HypixelHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new HypixelError($op . "_allow",
                "HypixelSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = HypixelHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new HypixelError("graphql_error",
                "HypixelSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Housing($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_housing === null) {
                $this->_housing = new HousingEntity($this, null);
            }
            return $this->_housing;
        }
        return new HousingEntity($this, $data);
    }
    ...
    public function Other($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_other === null) {
                $this->_other = new OtherEntity($this, null);
            }
            return $this->_other;
        }
        return new OtherEntity($this, $data);
    }
    ...
    public function PlayerData($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_player_data === null) {
                $this->_player_data = new PlayerDataEntity($this, null);
            }
            return $this->_player_data;
        }
        return new PlayerDataEntity($this, $data);
    }
    ...
    public function Resource($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_resource === null) {
                $this->_resource = new ResourceEntity($this, null);
            }
            return $this->_resource;
        }
        return new ResourceEntity($this, $data);
    }
    ...
    public function SkyBlock($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_sky_block === null) {
                $this->_sky_block = new SkyBlockEntity($this, null);
            }
            return $this->_sky_block;
        }
        return new SkyBlockEntity($this, $data);
    }
