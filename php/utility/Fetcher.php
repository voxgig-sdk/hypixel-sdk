...
// Hypixel SDK utility: fetcher

class HypixelFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; HypixelSDK/1.0)';
    ...
    public static function call(HypixelContext $ctx, string $fullurl, array $fetchdef): array
    {
