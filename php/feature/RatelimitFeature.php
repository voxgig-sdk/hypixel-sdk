...
class HypixelRatelimitFeature extends HypixelBaseFeature
{
    ...
    private function _acquire(HypixelContext $ctx): void
    {
    ...
    private function _track(HypixelContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
