...
class HypixelStreamingFeature extends HypixelBaseFeature
{
    ...
    private function _iterate(HypixelResult $result): \Generator
    {
    ...
    private function _streamable(HypixelContext $ctx): bool
    {
