...
class HypixelTimeoutFeature extends HypixelBaseFeature
{
    ...
    private function _with_timeout(HypixelContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(HypixelContext $_ctx, float $ms): void
    {
        $client = $this->client;
