...
class OtherEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $seen = iterator_to_array($base->Other(null)->stream("list", null, null), false);
        ...
        if (isset($cfg["feature"]) && is_array($cfg["feature"]) && isset($cfg["feature"]["streaming"])) {
            ...
            $got = [];
            foreach ($sdk->Other(null)->stream("list", null, null) as $item) {
    ...
    public function test_basic_flow(): void
    {
        ...
        $other_ref01_list_result = $other_ref01_ent->list($other_ref01_match, null);
        $this->assertIsArray($other_ref01_list_result);

        // LOAD
        $other_ref01_match_dt0 = [];
        $other_ref01_data_dt0_loaded = $other_ref01_ent->load($other_ref01_match_dt0, null);
