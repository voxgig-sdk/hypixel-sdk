...
class HypixelTestRunner
{
    ...
    {
        $live = self::getenv('HYPIXEL_TEST_LIVE');
        $override = self::getenv('HYPIXEL_TEST_OVERRIDE');
        ...
        $explain = self::getenv('HYPIXEL_TEST_EXPLAIN');
...
class_alias('HypixelTestRunner', 'Runner');
class_alias('HypixelHelpers', 'Helpers');
