...
{
    private static function utility(): HypixelUtility
    {
        return new HypixelUtility();
    }
    ...
    private static function ctx(array $over = []): HypixelContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new HypixelContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new HypixelOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof HypixelError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new HypixelOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = HypixelMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new HypixelOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = HypixelMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new HypixelOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = HypixelMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new HypixelSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = HypixelMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new HypixelResponse([]),
            'result' => new HypixelResult([]),
        ]);
        [, $err] = HypixelMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new HypixelSpec([]),
            'response' => null,
            'result' => new HypixelResult([]),
        ]);
        [, $err] = HypixelMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new HypixelSpec(['step' => 's']),
            'response' => new HypixelResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new HypixelResult([]),
        ]);
        [, $err] = HypixelMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new HypixelSpec(['step' => 's']),
            'response' => new HypixelResponse(self::resp(200, ['v' => 1])),
            'result' => new HypixelResult([]),
        ]);
        [, $err] = HypixelMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new HypixelSpec(['step' => 's']),
            'response' => new HypixelResponse(self::resp(200, ['v' => 2])),
            'result' => new HypixelResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        HypixelMakeResponse::call($ctx);
    ...
    {
        $preset = new HypixelResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new HypixelSpec([]),
            'response' => new HypixelResponse([]),
            'result' => new HypixelResult([]),
        ...
        [$got, $err] = HypixelMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new HypixelResult([])]);
        [, $err] = HypixelMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new HypixelSpec([]), 'result' => null]);
        [, $err] = HypixelMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new HypixelSpec(['step' => 's']),
            'result' => new HypixelResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new HypixelOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = HypixelMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new HypixelSpec(['step' => 's']),
            'result' => new HypixelResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new HypixelOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = HypixelMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new HypixelResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new HypixelSpec([]),
            'result' => new HypixelResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = HypixelMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = HypixelMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new HypixelError('boom', 'boom');
        $utility->fetcher = function (HypixelContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new HypixelSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = HypixelMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (HypixelContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = HypixelMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(HypixelResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (HypixelContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new HypixelSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = HypixelMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new HypixelResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new HypixelSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = HypixelMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = HypixelMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = HypixelMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new HypixelResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, HypixelDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new HypixelResult(['ok' => false])]);
        $this->expectException(HypixelError::class);
        HypixelDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new HypixelResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', HypixelMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        HypixelMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new HypixelBaseFeature();
        $b = new HypixelBaseFeature();
        HypixelFeatureAdd::call($ctx, $a);
        HypixelFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): HypixelBaseFeature
    {
        $f = new HypixelBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        HypixelFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): HypixelContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new HypixelSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = HypixelPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new HypixelResponse(['headers' => null]),
            'result' => new HypixelResult([]),
        ]);
        HypixelResultHeaders::call($ctx);
