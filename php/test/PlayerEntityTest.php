...
class PlayerEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set HYPIXEL_TEST_PLAYER_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function player_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("HYPIXEL_TEST_PLAYER_ENTID");
