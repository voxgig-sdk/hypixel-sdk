...
// Hypixel SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (HypixelSDK::test)
...
{
    private const SDK_CLASS = 'HypixelSDK';
    ...
    private const SDK_BASE = 'hypixel_sdk';
