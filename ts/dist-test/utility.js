...
function envOverride(m) {
    if ('TRUE' === process.env.HYPIXEL_TEST_LIVE ||
        'TRUE' === process.env.HYPIXEL_TEST_OVERRIDE) {
    ...
    m.HYPIXEL_TEST_EXPLAIN = process.env.HYPIXEL_TEST_EXPLAIN || m.HYPIXEL_TEST_EXPLAIN;
    return m;
}
