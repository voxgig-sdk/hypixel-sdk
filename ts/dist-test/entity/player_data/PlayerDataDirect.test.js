...
(0, node_test_1.describe)('PlayerDataDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-player_data', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-player_data', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-player_data', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-player_data', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HYPIXEL_TEST_PLAYER_DATA_ENTID'];
...
//# sourceMappingURL=PlayerDataDirect.test.js.map