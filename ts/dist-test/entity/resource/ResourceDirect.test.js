...
(0, node_test_1.describe)('ResourceDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-resource', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-resource', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HYPIXEL_TEST_RESOURCE_ENTID'];
...
//# sourceMappingURL=ResourceDirect.test.js.map