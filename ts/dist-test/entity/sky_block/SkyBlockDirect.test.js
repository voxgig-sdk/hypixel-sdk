...
(0, node_test_1.describe)('SkyBlockDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-sky_block', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-sky_block', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-sky_block', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-sky_block', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function liveScenariosActive() { return false && process.env.HYPIXEL_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.HypixelSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.HYPIXEL_APIKEY,
        }));
        let idmap = env['HYPIXEL_TEST_SKY_BLOCK_ENTID'];
    ...
    const client = new __1.HypixelSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=SkyBlockDirect.test.js.map