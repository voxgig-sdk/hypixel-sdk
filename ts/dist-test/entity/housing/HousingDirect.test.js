...
(0, node_test_1.describe)('HousingDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-housing', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-housing', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-housing', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-housing', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HYPIXEL_TEST_HOUSING_ENTID'];
...
//# sourceMappingURL=HousingDirect.test.js.map