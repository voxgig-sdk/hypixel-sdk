...
class HypixelSDK {
  ...
  async graphql(query: string, variables?: any, ctrl?: any) {
    ...
    if (null != errors && Array.isArray(errors) && 0 < errors.length) {
      ...
      const err: any = new Error('HypixelSDK: graphql: ' +
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Housing(entopts?: Record<string, any>) {
    const self = this
    return new HousingEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Other(entopts?: Record<string, any>) {
    const self = this
    return new OtherEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  PlayerData(entopts?: Record<string, any>) {
    const self = this
    return new PlayerDataEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Resource(entopts?: Record<string, any>) {
    const self = this
    return new ResourceEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  SkyBlock(entopts?: Record<string, any>) {
    const self = this
    return new SkyBlockEntity(self, entopts)
  }
