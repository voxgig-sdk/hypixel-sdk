-- Hypixel SDK Other entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local OtherEntity = {}
OtherEntity.__index = OtherEntity


function OtherEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OtherEntity)
  self._name = "other"
  self._client = client
...
function OtherEntity:get_name()
  return self._name
end


function OtherEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return OtherEntity.new(self._client, opts)
end
...
function OtherEntity:mark_deleted()
  self._deleted = true
end


function OtherEntity:deleted()
  return true == self._deleted
end


function OtherEntity:data_set(args)
  if args ~= nil then
...
function OtherEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OtherEntity:match_set(args)
  if args ~= nil then
...
function OtherEntity:match_get()
...
function OtherEntity:stream(action, args, callopts)
...
function OtherEntity:_run_op(ctx, post_done)
  local utility = self._utility
