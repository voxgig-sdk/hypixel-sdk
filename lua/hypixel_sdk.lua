...
HypixelSDK._make_feature = _make_feature


function HypixelSDK.new(options)
  local self = setmetatable({}, HypixelSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function HypixelSDK:options_map()
...
function HypixelSDK:get_utility()
  return Utility.copy(self._utility)
end


function HypixelSDK:get_root_ctx()
  return self._rootctx
end


function HypixelSDK:prepare(fetchargs)
...
function HypixelSDK:direct(fetchargs)
...
-- by passing it.
function HypixelSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function HypixelSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "HypixelSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function HypixelSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = HypixelSDK.new(sdkopts)
  sdk.mode = "test"
