...
describe("OtherDirect", function()
  it("should direct-list-other", function()
    local setup = other_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-other", setup.live and "live" or "unit")
  ...
  it("should direct-load-other", function()
    local setup = other_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-other", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function other_direct_setup(mockres)
