...
describe("ResourceDirect", function()
  it("should direct-load-resource", function()
    local setup = resource_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-resource", setup.live and "live" or "unit")
...
function resource_direct_setup(mockres)
