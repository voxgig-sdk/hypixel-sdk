...
-- data to return.
local TEST_SEED = '{ entity = { ["guild"] = { ["test01"] = { id = "test01" } }, ["housing"] = { ["test01"] = { id = "test01" } }, ["other"] = { ["test01"] = { id = "test01" } }, ["player"] = { ["test01"] = { id = "test01" } }, ["player_data"] = { ["test01"] = { id = "test01" } }, ["resource"] = { ["test01"] = { id = "test01" } }, ["sky_block"] = { ["test01"] = { id = "test01" } } } }'
