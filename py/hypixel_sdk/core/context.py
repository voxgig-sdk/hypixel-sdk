...
from hypixel_sdk.core.helpers import get_ctx_prop, to_map
...
class HypixelContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, HypixelResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return HypixelError(code, msg, self)
