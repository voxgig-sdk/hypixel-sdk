...
from hypixel_sdk.utility import register

# Load features
from hypixel_sdk.feature.base_feature import HypixelBaseFeature
from hypixel_sdk.features import _has_feature, _make_feature
...
class HypixelSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = HypixelUtility()
        self._utility = utility

        from hypixel_sdk.config import shared_config
    ...
    def get_utility(self):
        return HypixelUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("HypixelSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Guild(self, data=None) -> "GuildEntity":
        ...
        from hypixel_sdk.entity.guild_entity import GuildEntity
    ...
    def Player(self, data=None) -> "PlayerEntity":
        ...
        from hypixel_sdk.entity.player_entity import PlayerEntity
    ...
    def PlayerData(self, data=None) -> "PlayerDataEntity":
        ...
        from hypixel_sdk.entity.player_data_entity import PlayerDataEntity
    ...
    def Resource(self, data=None) -> "ResourceEntity":
        ...
        from hypixel_sdk.entity.resource_entity import ResourceEntity
    ...
    def SkyBlock(self, data=None) -> "SkyBlockEntity":
        ...
        from hypixel_sdk.entity.sky_block_entity import SkyBlockEntity
