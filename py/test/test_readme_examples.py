# Hypixel SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions HypixelSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both HypixelSDK(...) and HypixelSDK.test(...) become
#      HypixelSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "hypixel_sdk"
_SDK_CLASS = "HypixelSDK"
