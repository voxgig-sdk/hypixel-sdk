...
from hypixel_sdk.core.response import HypixelResponse
from hypixel_sdk.core.operation import HypixelOperation
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = HypixelSDK.test(None, None)
        ...
        class TestInitFeature(HypixelBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(HypixelBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = HypixelSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = HypixelSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = HypixelSDK.test(None, setup_opts)
