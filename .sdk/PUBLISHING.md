...
|---|---|---|
| `ts/` | @voxgig-sdk/hypixel-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/hypixel-sdk \
      --repository voxgig-sdk/hypixel-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/hypixel-sdk` shows it, and
`npm trust revoke @voxgig-sdk/hypixel-sdk --id=<id>` removes it.
