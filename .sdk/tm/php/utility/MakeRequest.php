...
// Hypixel SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class HypixelMakeRequest
{
    public static function call(HypixelContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new HypixelResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new HypixelResponse($fetched);
        } else {
