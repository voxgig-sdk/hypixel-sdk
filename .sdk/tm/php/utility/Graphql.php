...
class HypixelGraphql
{
    ...
    // equivalent.
    public static function body(HypixelContext $ctx): mixed
    {
    ...
    public static function errors(HypixelContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
