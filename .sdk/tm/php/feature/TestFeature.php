...
// Hypixel SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class HypixelTestFeature extends HypixelBaseFeature
{
    ...
    public function init(HypixelContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (HypixelContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (HypixelContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(HypixelContext $ctx, $op, $args): array
    {
