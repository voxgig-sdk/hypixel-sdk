...
class HypixelProxyFeature extends HypixelBaseFeature
{
    ...
    public function init(HypixelContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (HypixelContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
