...
class HypixelNetsimFeature extends HypixelBaseFeature
{
    ...
    private function _simulate(HypixelContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(HypixelContext $ctx, array $applied): void
    {
        $client = $this->client;
