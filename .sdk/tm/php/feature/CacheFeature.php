...
class HypixelCacheFeature extends HypixelBaseFeature
{
    ...
    private function _through(HypixelContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
