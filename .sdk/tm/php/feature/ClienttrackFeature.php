...
// Hypixel SDK clienttrack feature
...
class HypixelClienttrackFeature extends HypixelBaseFeature
{
    ...
    public function PostConstruct(HypixelContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Hypixel-SDK';
