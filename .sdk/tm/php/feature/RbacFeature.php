...
class HypixelRbacFeature extends HypixelBaseFeature
{
    ...
    private function _required(HypixelContext $ctx): ?string
    {
    ...
    private function _reject(HypixelContext $ctx, string $required): void
    {
    ...
    private function _track(HypixelContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
