...
// Hypixel SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = HypixelOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(HypixelOmni::structfix($now, Struct::undef()))
                        !== json_encode(HypixelOmni::structfix($val, Struct::undef()))) {
