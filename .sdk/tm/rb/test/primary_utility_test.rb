...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = HypixelOmni.make_runner(TEST_JSON_FILE, HypixelSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : HypixelOmni.errify(err)
    end
