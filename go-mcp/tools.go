...
type Args struct {
	Entity string         `json:"entity" jsonschema:"guild | housing | other | player | player_data | resource | sky_block"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.HypixelSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "hypixel_list",
		Description: "List records from Hypixel. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "hypixel_load",
		Description: "Load a single record from Hypixel. " +
...
func runOp(client *sdk.HypixelSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.HypixelSDK, name string) (sdk.HypixelEntity, error) {
	switch strings.ToLower(name) {
	case "guild":
		return client.Guild(nil), nil
	case "housing":
		return client.Housing(nil), nil
	case "other":
		return client.Other(nil), nil
	case "player":
		return client.Player(nil), nil
	case "player_data":
		return client.PlayerData(nil), nil
	case "resource":
		return client.Resource(nil), nil
	case "sky_block":
		return client.SkyBlock(nil), nil
