...
```go
result, err := client.Housing(nil).Load(map[string]any{"house": "house"}, nil)
if err != nil {
    panic(err)
}
fmt.Println(result)
...
```go
result, err := client.Player(nil).Load(map[string]any{"uuid": "uuid"}, nil)
if err != nil {
    panic(err)
}
fmt.Println(result)
...
```go
result, err := client.PlayerData(nil).Load(map[string]any{"uuid": "uuid"}, nil)
if err != nil {
    panic(err)
}
fmt.Println(result)
...
```go
result, err := client.SkyBlock(nil).Load(map[string]any{"profile": "profile"}, nil)
if err != nil {
    panic(err)
}
fmt.Println(result)
