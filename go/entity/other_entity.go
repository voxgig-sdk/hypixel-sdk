...
func NewOtherEntity(client *core.HypixelSDK, entopts map[string]any) *OtherEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *OtherEntity) GetName() string { return e.name }
...
func (e *OtherEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *OtherEntity) Deleted() bool {
	return e.deleted
}


func (e *OtherEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewOtherEntity(e.client, opts)
}

func (e *OtherEntity) Data(args ...any) any {
...
func (e *OtherEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Other; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *OtherEntity) DataTyped(data ...Other) Other {
	if len(data) > 0 {
		return typedFrom[Other](e.Data(asMap(data[0])))
	}
	return typedFrom[Other](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Other (all fields
// optional at the wire level).
func (e *OtherEntity) MatchTyped(match ...Other) Other {
	if len(match) > 0 {
		return typedFrom[Other](e.Match(asMap(match[0])))
	}
	return typedFrom[Other](e.Match())
}
...
func (e *OtherEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *OtherEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// OtherLoadMatch and returns an Other. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *OtherEntity) LoadTyped(reqmatch OtherLoadMatch, ctrl map[string]any) (Other, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Other{}, err
	}
	return typedFrom[Other](res), nil
}




func (e *OtherEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// OtherListMatch and returns []Other. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *OtherEntity) ListTyped(reqmatch OtherListMatch, ctrl map[string]any) ([]Other, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Other](res), nil
}



func (e *OtherEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *OtherEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *OtherEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *OtherEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
