...
func NewResourceEntity(client *core.HypixelSDK, entopts map[string]any) *ResourceEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ResourceEntity) GetName() string { return e.name }
...
func (e *ResourceEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ResourceEntity) Deleted() bool {
	return e.deleted
}


func (e *ResourceEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewResourceEntity(e.client, opts)
}

func (e *ResourceEntity) Data(args ...any) any {
...
func (e *ResourceEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Resource; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ResourceEntity) DataTyped(data ...Resource) Resource {
	if len(data) > 0 {
		return typedFrom[Resource](e.Data(asMap(data[0])))
	}
	return typedFrom[Resource](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Resource (all fields
// optional at the wire level).
func (e *ResourceEntity) MatchTyped(match ...Resource) Resource {
	if len(match) > 0 {
		return typedFrom[Resource](e.Match(asMap(match[0])))
	}
	return typedFrom[Resource](e.Match())
}
...
func (e *ResourceEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ResourceEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ResourceLoadMatch and returns an Resource. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ResourceEntity) LoadTyped(reqmatch ResourceLoadMatch, ctrl map[string]any) (Resource, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Resource{}, err
	}
	return typedFrom[Resource](res), nil
}



func (e *ResourceEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ResourceEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ResourceEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ResourceEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ResourceEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
