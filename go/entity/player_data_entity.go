...
type PlayerDataEntity struct {
	name    string
	client  *core.HypixelSDK
...
func NewPlayerDataEntity(client *core.HypixelSDK, entopts map[string]any) *PlayerDataEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PlayerDataEntity) GetName() string { return e.name }
...
func (e *PlayerDataEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PlayerDataEntity) Deleted() bool {
	return e.deleted
}


func (e *PlayerDataEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPlayerDataEntity(e.client, opts)
}

func (e *PlayerDataEntity) Data(args ...any) any {
...
func (e *PlayerDataEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PlayerData; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PlayerDataEntity) DataTyped(data ...PlayerData) PlayerData {
	if len(data) > 0 {
		return typedFrom[PlayerData](e.Data(asMap(data[0])))
	}
	return typedFrom[PlayerData](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PlayerData (all fields
// optional at the wire level).
func (e *PlayerDataEntity) MatchTyped(match ...PlayerData) PlayerData {
	if len(match) > 0 {
		return typedFrom[PlayerData](e.Match(asMap(match[0])))
	}
	return typedFrom[PlayerData](e.Match())
}
...
func (e *PlayerDataEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PlayerDataEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PlayerDataLoadMatch and returns an PlayerData. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PlayerDataEntity) LoadTyped(reqmatch PlayerDataLoadMatch, ctrl map[string]any) (PlayerData, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return PlayerData{}, err
	}
	return typedFrom[PlayerData](res), nil
}




func (e *PlayerDataEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// PlayerDataListMatch and returns []PlayerData. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PlayerDataEntity) ListTyped(reqmatch PlayerDataListMatch, ctrl map[string]any) ([]PlayerData, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[PlayerData](res), nil
}



func (e *PlayerDataEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PlayerDataEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PlayerDataEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PlayerDataEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
