...
func NewHousingEntity(client *core.HypixelSDK, entopts map[string]any) *HousingEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *HousingEntity) GetName() string { return e.name }
...
func (e *HousingEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *HousingEntity) Deleted() bool {
	return e.deleted
}


func (e *HousingEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewHousingEntity(e.client, opts)
}

func (e *HousingEntity) Data(args ...any) any {
...
func (e *HousingEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *HousingEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *HousingEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
func (e *HousingEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *HousingEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *HousingEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *HousingEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
