...
func NewSkyBlockEntity(client *core.HypixelSDK, entopts map[string]any) *SkyBlockEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SkyBlockEntity) GetName() string { return e.name }
...
func (e *SkyBlockEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SkyBlockEntity) Deleted() bool {
	return e.deleted
}


func (e *SkyBlockEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSkyBlockEntity(e.client, opts)
}

func (e *SkyBlockEntity) Data(args ...any) any {
...
func (e *SkyBlockEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *SkyBlockEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SkyBlockEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
func (e *SkyBlockEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SkyBlockEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SkyBlockEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SkyBlockEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
