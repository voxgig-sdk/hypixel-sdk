...
func (sdk *HypixelSDK) OptionsMap() map[string]any {
...
func (sdk *HypixelSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *HypixelSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *HypixelSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *HypixelSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *HypixelSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *HypixelSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("HypixelSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *HypixelSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *HypixelSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("HypixelSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
