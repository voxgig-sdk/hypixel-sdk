...
const testSeed = `map[string]any{"entity": map[string]any{"guild": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "housing": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "other": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "player": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "player_data": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "resource": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "sky_block": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
