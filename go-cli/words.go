...
func registerSDKWords(r *eng.Registry, client *sdk.HypixelSDK) {
...
func runOp(client *sdk.HypixelSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
