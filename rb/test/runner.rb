...
module HypixelTestRunner
  ...
  def self.env_override(m)
    live = getenv("HYPIXEL_TEST_LIVE")
    override = getenv("HYPIXEL_TEST_OVERRIDE")
    ...
    explain = getenv("HYPIXEL_TEST_EXPLAIN")
    m["HYPIXEL_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = HypixelTestRunner
Helpers = HypixelHelpers
Vs = VoxgigStruct
