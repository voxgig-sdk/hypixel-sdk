...
class OtherEntity
  ...
  #   as an empty match, so client.Other.load works with no args).
  ...
  #
  # @param reqmatch [OtherListMatch, Hash, nil] match filter (any subset of
  #   Other fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
